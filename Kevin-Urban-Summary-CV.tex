...
\noindent\textbf{Programming / Tools}: Proficient in Python, R,
TensorFlow, Keras, SQL,
  Amazon Web Services (Redshift, S3, EC2, EBS), Tableau, MatLab, IDL, PostgreSQL, 
  UNIX, Bash, LaTeX, Vim, HTML, CSS, MarkDown; Limited / Classroom
...
\vspace{-0.2cm}
\begin{itemize*}
  \item \textbf{Structured & Unstructured Data} (e.g., sensors, instrumentation, 
    images, text, time series, geospatial, simulation, genomics, commerce)
...
\begin{itemize*}
  \item Design and deployment of deep neural network models in Keras and TensorFlow 
    ...
    and lifetime value (multilayer perceptrons, autoencoders) 
  \item Development of wrestler image recognition algorithm using transfer learning,
    convolutional nets
